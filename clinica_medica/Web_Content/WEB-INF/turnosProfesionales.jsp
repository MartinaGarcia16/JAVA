    			...
    			<tbody>
   					 ...
   					 <% for (Turnos t:turnos) { %> 
	      				<tr>
							...
							<td><%=t.getPac().getNombre() + " " + t.getPac().getApellido()%></td>	
							<td><%=t.getPac().getOs().getNombre()%></td>
	      				</tr>
    				 <% } %>
   				</tbody> 
  			</table>
  			<button class="input-button" name="nro_turno" type="submit" value="-1">Volver atras</button>
		</div>
	</form>
